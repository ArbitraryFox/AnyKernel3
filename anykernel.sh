...
# begin properties
properties() { '
kernel.string=Initializing process.
do.devicecheck=1
do.modules=0
do.systemless=1
do.cleanup=1
...
# update init.rc
insert_line init.rc "import /init.orokin.rc" after "import /init.\${ro.zygote}.rc" "import /init.orokin.rc";

# end ramdisk changes
ui_print "Now writing boot..."

ui_print "Process clear."

ui_print "Begin cleanup..."
